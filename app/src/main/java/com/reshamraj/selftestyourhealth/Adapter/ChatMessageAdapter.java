package com.reshamraj.selftestyourhealth.Adapter;
...
import com.reshamraj.selftestyourhealth.R;
...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatMessageAdapter(@NonNull Context context, List<ChatMessage> data) {
        super(context, R.layout.user_activity, data);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (viewType==MY_MESSAGE){
            ...
            convertView= LayoutInflater.from(getContext())
                    .inflate(R.layout.bots_reply,parent,false);
            TextView textView= convertView.findViewById(R.id.chat_text);
            textView.setText(getItem(position).getContent());

        }
        convertView.findViewById(R.id.chatm).setOnClickListener(new View.OnClickListener() {
            @Override
